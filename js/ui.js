            ...
            if (driver.weeklyActivity && driver.weeklyActivity.length === 7) {
                ...
                driver.weeklyActivity.forEach(activity => {
                    ...
                    // --- UPDATED COLOR LOGIC ---
                        ...
                        // 3. Green Statuses (WITHOUT_LOAD is treated as ACTIVE)
...
export function openActivityHistoryModal(driver, mileageData, settings, daysTakenHistory, dispatcherOverrides, allLockedData = {}, allWeeklyNotes = {}, allContracts = {}) {
